...
for (name in all_names){
	...
	MyData <- read.csv(file=paste(out_folder,name,"_rate_.csv",sep = ""), header=FALSE, sep=",")
	...
	if(identical(typeof(model),"character")){
		...
		#dev.copy(png,paste(out_folder,name,"rate.png"))
		#dev.off()
		#graphics.off()
...
# output
write.csv(lin_model,paste(out_folder,"lin_rate.csv",sep = ""))
write.csv(glarma_model,paste(out_folder,"glarma_rate.csv",sep = ""))
write.csv(glm_model,paste(out_folder,"glm_rate.csv",sep = ""))
